<div align="center" style="background: rgba(0, 0, 0, 0.8); border-radius: 20px; padding: 25px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.6);">
  <img src="https://github-widgetbox.vercel.app/api/profile?username=Hyakkkimaru&data=followers,repositories,stars,commits&theme=nautilus" alt="GitHub WidgetBox" style="border-radius: 15px; transition: transform 0.3s; max-width: 100%; height: auto;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" />
</div>
...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=Hyakkkimaru&theme=onedark&no-frame=true&row=1&column=6" alt="GitHub Trophies" width="800" style="border-radius: 10px; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'" />
</div>
